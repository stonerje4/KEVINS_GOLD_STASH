...
> [GMGN](https://gmgn.ai/sol/address/HCDsVE5Y22dzxFzibEFSq4UD4RdHAvQKUHPuTcRJUGmQ) | [Solscan](https://solscan.io/account/HCDsVE5Y22dzxFzibEFSq4UD4RdHAvQKUHPuTcRJUGmQ) | Updated: 2026-03-21 08:05 UTC

## Summary

| Metric | Value |
|--------|-------|
| Trades | 8 (3 open, 5 closed) |
| W/L | 0/5 (0%) |
| 💵 Realized | -0.5950 SOL ($-53.58) |
| ⛽ Gas | 0.0250 SOL |
| 📦 Unrealized | -0.0267 SOL |
| 🏦 Net | **-0.6217 SOL** ($-55.99) |

## Positions

| Token | Status | Entry SOL | Current | Peak | Net SOL | Reason |
|-------|--------|-----------|---------|------|---------|--------|
| 🔴 ? | open | 0.11 | 0.95x | 1.03x | -0.0107 | — |

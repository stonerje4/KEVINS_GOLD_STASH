...
- **Peak:** 1.07x | **Current:** 1.02x
- **Mint:** `9JbxQSKNukRA7cPZxCfhSNEcAP9iKRo3PSyYNbW4pump`

| Time | Action | SOL | TX |
|------|--------|-----|----|
| 2026-03-17 06:23:44 | BUY | 0.000100 | `5SB6jaYk4N3XEB3GX19Fmgwgs6vs3z...` |

### 🟢 zeroxoneb
- **Status:** partial | **Exit:** open
- **Peak:** 2.25x | **Current:** 1.23x
...
### 🟢 WRT
- **Status:** open | **Exit:** open
- **Peak:** 1.37x | **Current:** 1.17x
- **Mint:** `D69bugFJG4y3kmJxiLPTMuqqK3e3PnJHQCcQvALgpump`

| Time | Action | SOL | TX |
|------|--------|-----|----|
| 2026-03-16 13:32:07 | BUY | 0.000600 | `5yeePK8AEV8f6oG5wpx6qo7Bfmq6SC...` |
...
| Time | Action | SOL | TX |
|------|--------|-----|----|
| 2026-03-16 08:19:08 | BUY | 0.000600 | `5c7AjL6MSLNpiC5dSpzU6NJ17LA8sN...` |

### 🟢 LARP
- **Status:** open | **Exit:** open
- **Peak:** 1.61x | **Current:** 1.20x
...
### 🟢 Sonny
- **Status:** open | **Exit:** open
- **Peak:** 1.09x | **Current:** 0.72x
- **Mint:** `EVHhyNdtZxXCvRVXeAggjXiahoAQxXhsifFEw6yWpump`

| Time | Action | SOL | TX |
|------|--------|-----|----|
| 2026-03-16 06:38:04 | BUY | 0.000600 | `3yrh4vXRnA4GqqAbVuPJJSNapWbEpc...` |

### 🔴 LOCK
- **Status:** closed | **Exit:** ghost_close_stop_loss
- **Peak:** 1.45x | **Current:** 0.70x
- **Mint:** `BWZkw5KaHh3jzqagqZpgdHYvEvrkyoAovQ5AFwmVpump`

| Time | Action | SOL | TX |
|------|--------|-----|----|
| 2026-03-16 05:33:25 | BUY | 0.000600 | `36PB9KA3iPGuZuvTKJAufgaxGP3QYG...` |
| 2026-03-16 13:11:38 | SELL | 0.000419 | `2SubQvdLPrQRMPPFFwh5fm4bDPaUXn...` |
...
| Time | Action | SOL | TX |
|------|--------|-----|----|
| 2026-03-16 05:23:51 | BUY | 0.000600 | `25CBWRWspykeSkYYdGiuG4JEd6n7rF...` |
...
### 🔴 CORGI
- **Status:** closed | **Exit:** ghost_close_stop_loss
- **Peak:** 1.04x | **Current:** 0.65x
- **Mint:** `CQnTXFK4zZ6yxEfWw1EntYmawYahEi13JhnTKzhmpump`

| Time | Action | SOL | TX |
|------|--------|-----|----|
| 2026-03-16 04:02:42 | BUY | 0.000600 | `49BhJQxiiwRwmCGrQmqFPjSMNm4RaM...` |
| 2026-03-16 04:07:10 | SELL | 0.000391 | `x2SLUp2pgjHLm6fXt4x4og8wgA3joo...` |

### 🟢 sima
- **Status:** open | **Exit:** open
- **Peak:** 1.77x | **Current:** 0.88x
